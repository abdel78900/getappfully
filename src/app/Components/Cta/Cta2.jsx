        ...
        <div className="service-container-wrapper style3  section-padding fix">
            ...
            <div className="container">
                <div className="service-wrapper style3">
                    <h2 className="wow fadeInUp" data-wow-delay=".3s">Transform Your Business with Mobile Technology
                    </h2>
                    <p className="text wow fadeInUp" data-wow-delay=".5s">We specialize in creating high-performance mobile applications that drive business growth. Our cross-platform solutions using React Native and Flutter ensure your app reaches the maximum audience while maintaining exceptional user experience and native performance across iOS and Android platforms.</p>

                    <Link href="/contact"> <span className="theme-btn wow fadeInUp" data-wow-delay=".3s"> Start Your Project
