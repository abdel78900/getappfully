                        ...
                        <div className="col-xl-4 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".2s">
                            <div className="single-footer-widget">
                                ...
                                <div className="footer-content">
                                    <p>
                                        GetAppFully specializes in cross-platform mobile app development using React Native and Flutter to create powerful iOS and Android applications.
                                    </p>
                                    <div className="store-links">
                                        ...
                                        <div className="play">
                                            <a href="https://play.google.com/store/apps/details?id=com.getappfully.worldcupquizz"><svg xmlns="http://www.w3.org/2000/svg" width="26" height="17"
                        ...
                        <div className="col-xl-4 col-lg-4 col-md-6">
                            <div className="single-footer-widget">
                                <div className="contact-box">
                                    ...
                                    <div className="widget-head">Ready to build your app?</div>
                                    <div className="text">Get in touch to discuss your mobile app project. We're here to help bring your ideas to life.
                                    </div>
                                    <div className="info">
                                        ...
                                        <div className="link">
                                            <a href="mailto:worldcupquizz@gmail.com">worldcupquizz@gmail.com</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div className="container">
                    <div className="footer-wrapper d-flex align-items-center justify-content-between">
                        <p className="wow fadeInLeft" data-wow-delay=".3s">
                            Copyright © GetAppFully All rights reserved
                        </p>
